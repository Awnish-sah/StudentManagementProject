...
namespace OnlineShoppingStore.Controllers
{
    public class RegistrationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,course_id,batch_id,phno")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,firstname,lastname,course_id,batch_id,phno")] registration registration)
        {
            if (ModelState.IsValid)
            {
